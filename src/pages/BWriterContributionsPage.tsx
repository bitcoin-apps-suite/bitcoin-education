...
const BWriterContributionsPage: React.FC = () => {
  ...
  const [todoItems] = useState<TodoItem[]>([
    ...
    {
      id: '10',
      title: 'Bitcoin Education Exchange',
  ...
  const fetchContributors = async () => {
    try {
      const response = await fetch('https://api.github.com/repos/bitcoin-apps-suite/bitcoin-education/contributors');
      if (response.ok) {
        ...
        <div className="contributions-container">
          ...
          <section className="contributions-hero">
            ...
            <p className="contributions-tagline">
              Contribute to Bitcoin Education and earn $BWriter tokens
            </p>
          ...
          <div className="github-section">
            ...
            <div className="repo-link">
              ...
              >
                ...
                bitcoin-apps-suite/bitcoin-education
              </a>
            </div>
                ...
                {showCompletedTasks && (
                  <div style={{ 
                    ...
                    <div style={{
                      ...
                      ({(TOTAL_TOKENS * 7.5 / 100).toLocaleString()} $BEDUCATION)
                    </div>
                  </div>
                )}
              ...
              <div key={item.id} className="todo-item">
                ...
                <div className="todo-footer">
                  ...
                  {item.githubIssueNumber && (
                    <a 
                      href={`https://github.com/bitcoin-apps-suite/bitcoin-education/issues/${item.githubIssueNumber}`}
                      target="_blank"
                      rel="noopener noreferrer"
